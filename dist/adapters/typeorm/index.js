...
var Adapter = function Adapter(typeOrmConfig) {
  ...
  function _getAdapter() {
    _getAdapter = _asyncToGenerator(function* (appOptions) {
      ...
      function _getUsers() {
        _getUsers = _asyncToGenerator(function* () {
          ...
          try {
            ...
            _logger.default.error('GET_USERS_ERROR', error);
      ...
      function getAccounts(_x19) {
        return _getAccounts.apply(this, arguments);
      }

      function _getAccounts() {
        _getAccounts = _asyncToGenerator(function* (userId) {
          debug('GET_ACCOUNTS', userId);

          try {
            var accounts = yield connection.getRepository(Account).find({
              userId
            });
            ...
            _logger.default.error('GET_ACCOUNTS_ERROR', error);
      ...
      function getAccount(_x20, _x21) {
        return _getAccount.apply(this, arguments);
      }

      function _getAccount() {
        _getAccount = _asyncToGenerator(function* (userId, providerId) {
          ...
          try {
            ...
            _logger.default.error('GET_ACCOUNT_ERROR', error);
      ...
      function updateSession(_x24, _x25) {
      ...
      function createVerificationRequest(_x27, _x28, _x29, _x30, _x31) {
      ...
      function getVerificationRequest(_x32, _x33, _x34, _x35) {
      ...
      function deleteVerificationRequest(_x36, _x37, _x38, _x39) {
